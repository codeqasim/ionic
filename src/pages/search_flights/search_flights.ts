...
import { Flight_resultPage } from '../flight_result/flight_result';

@Component({
  selector: 'page-search_flights',
  templateUrl: 'search_flights.html',
  providers: [DatePickerDirective],
})
export class Search_flightsPage {
 ...
 flight_result(){
        this.navCtrl.push(Flight_resultPage)
  } 
